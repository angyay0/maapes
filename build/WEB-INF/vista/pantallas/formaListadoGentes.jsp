      ...
      <div class="table" style="width:100%"  id="tablecontent">
          <div class="tr">
              <div class="td" colspan="4" style="padding-top:25px; padding-bottom:25px;">
                  <a href="solicitarRegistroGente.do" class="HipervinculoAdmon boton btn btn-primary">Agregar nueva persona...</a>
              </div>
	      <div class="td" colspan="4" style="padding-top:25px; padding-bottom:25px;">
			<a href="solicitarReporte.do" class="HipervinculoAdmon boton btn btn-success">Ver Reporte</a>
	      </div>
          </div>
          <div class="tr">
          ...
          <c:forEach var="gente" items="${formaListadoGentes.gentes}">
              <div class="tr">
                  ...
                  <div class="td" align="left" style="width:16%">
                      <a href='solicitarModificarGente.do?id=<c:out value="${gente.id}"/>&idCiudad=<c:out value="${gente.idCiudad}" />&nombres=<c:out value="${gente.nombres}" />&apellidos=<c:out value="${gente.apellidos}" />&direccion=<c:out value="${gente.direccion}" />&telefono=<c:out value="${gente.telefono}" />'
