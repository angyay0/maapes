                ...
                <div class="td" align="left" style="position:relative">
                  ...
                  <!--<div class="buscar">
                    ...
                    <!--<input type="text" 
                           name="idCiudad" 
                           size="50" 
                           maxlength="100" value="${formaNuevoGente.idCiudad}"/> -->
            ...
            <div class="tr">
                <div class="td" style="width:400px;" align="center">
                    ...
                    <input type="submit" 
                           ...
                           onclick="forma.action='procesarRegistroGente.do?volver=si'" class="btn btn-primary"/>
                    <input type="button"
                           value="Reset"
                           onclick="location.href='solicitarRegistroGente.do'" class="btn btn-primary"/>
                    <input type="submit" 
