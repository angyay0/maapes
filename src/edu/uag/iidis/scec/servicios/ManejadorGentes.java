...
public class ManejadorGentes {
    ...
    public Gente getByName(String names) {
        Gente resultado;
    ...
    public int crearGente(Gente gente) {
        ...
        try {
            HibernateUtil.beginTransaction();           
            System.out.println(gente.getNombres());
     ...
     public int modificarGente(Gente gente) {

        int resultado;

        if (log.isDebugEnabled()) {
            log.debug(">modificarGente(gente)");
        }
        ...
        try {
            ...
            HibernateUtil.beginTransaction();           
            System.out.println(gente.getNombres());
            dao.hazModificacion(gente);
			resultado = 0; // Exito. modificacion hecha satisfactoriamente.
            HibernateUtil.commitTransaction();
