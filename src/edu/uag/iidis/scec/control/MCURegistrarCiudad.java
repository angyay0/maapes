...
public final class MCURegistrarCiudad 
	...
	public ActionForward solicitarModificarCiudad(
                ActionMapping mapping,
                ActionForm form,
                HttpServletRequest request,
                HttpServletResponse response)
        ...
        FormaModificarCiudad forma = (FormaModificarCiudad)form;
        ...
        if (log.isDebugEnabled()) {
            log.debug(">solicitarModificarCiudad");
        }
    ...
    public ActionForward procesarRegistroCiudad(
        ...
        Ciudad rol = new Ciudad(forma.getNombre(), forma.getidEstado());
	...
	public ActionForward procesarModificarCiudad(
                ActionMapping mapping,
                ActionForm form,
                HttpServletRequest request,
                HttpServletResponse response)
        ...
        Ciudad rol = new Ciudad(forma.getNombre(), forma.getidEstado(), forma.getId());

        ManejadorCiudades mr = new ManejadorCiudades();
        int resultado = mr.modificarCiudad(rol);
